...
<nav id="navigation">
  <div class="row align-items-center justify-content-between">
    <div class="col-md-4 site-logo">
      <a href="/"><img src="images/jungo_logo.svg" /></a>
    </div>
    ...
    <div class="hamburger-content">
      <ul>
        <li>
          ...
          <ul class="sub-menu">
            <li><a href="/about-us.php#about-us" class="nav-item">About Us</a></li>
            <li><a href="/about-us.php#our-team" class="nav-item">Our Team</a></li>
            <li><a href="/about-us.php#google-map" class="nav-item">Contact</a></li>
          </ul>
        </li>
        <li>
